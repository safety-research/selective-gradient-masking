...
torchrun --standalone --nproc_per_node=4 \
    ...
    --run-name "ts_2d_${ROUTE_STRATEGY}_mlp${ROUTE_MLP_DIM}_h${ROUTE_ATTN_HEADS}_ret${RETAIN_PERC}_pr${PRECISION}_rec${RECALL}"
...
torchrun --standalone --nproc_per_node=4 \
    ...
    --logit-calibration-steps 200 \
    --logit-on-intermediate \
    --run-name "ts_2d_datafilter_pr${PRECISION}_rec${RECALL}"